...
//         <Button className="bg-[#A2A970] text-black hover:bg-[#9ca25c] flex items-center gap-2">
//           <Phone className="w-4 h-4" /> Voice Call
//         </Button>
//         <Button
//           variant="outline"
//           className="border-[#A2A970] text-[#A2A970] hover:bg-[#2A2A2A] flex items-center gap-2"
//         >
