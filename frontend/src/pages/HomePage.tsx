    ...
    <div className="relative min-h-screen flex flex-col bg-[#0F0F11] text-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10">
        <motion.div
          ...
          className="absolute w-96 h-96 bg-gradient-to-r from-[#A2A970] to-[#5AF1C1] rounded-full opacity-10 blur-3xl top-[-20%] left-[-10%]"
        />
        <motion.div
          animate={{ rotate: -360 }}
          transition={{ duration: 180, repeat: Infinity, ease: "linear" }}
          className="absolute w-80 h-80 bg-gradient-to-r from-[#F45A97] to-[#FFC76D] rounded-full opacity-10 blur-3xl bottom-[-20%] right-[-10%]"
        />
      </div>

      {/* Header */}
      <header className="flex justify-between items-center px-8 py-4 bg-[#202020]/90 backdrop-blur-md sticky top-0 z-50">
        <h1 className="text-2xl font-bold tracking-wide text-[#A2A970]">
          Chatify
        </h1>
        <div className="flex gap-4">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-8 py-20 gap-10 md:gap-20">
        <motion.div
          ...
          className="flex-1 space-y-6"
        >
          <h2 className="text-5xl md:text-6xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-[#A2A970] via-[#5AF1C1] to-[#F45A97] animate-gradient-text">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {features.map((f, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: i * 0.2 }}
              className="flex flex-col items-center text-center gap-4 p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 hover:scale-105 transition-transform cursor-pointer"
            >
